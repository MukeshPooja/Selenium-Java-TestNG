...
public class EmailSender {
	...
	public static void main(String[] args) {
		...
		final String senderEmail = "demo1.berrysharma19@gmail.com";
		final String appPassword = "viwaqlmxjljpayxm";
		final String recipientEmail = "demo1.berrysharma19@gmail.com";
